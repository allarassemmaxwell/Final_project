	...
	<body>
		...
		<div class="main-content">
            ...
            <div class="title-left" style="font-size: 15px; color: #737373;">
				<a style="text-decoration: none" class="primary" href="product-service.php">Product/Service</a>/ Update
            </div>
            ...
            <form class="edit-page" name="productServiceForm" method="POST" onsubmit="return productServiceValidation()">
                ...
                <div>
                    <input class="button-primary" name="update-product-service" type="submit" value="Update Product/Service">
                </div>
            </form>  
