		...
		<div class="main-content">
			...
			<div style="overflow-x:auto;" id="tblCustomers" cellspacing="0" cellpadding="0">
				<div class="report-title">
					<div class="report-filter" style="font-size:18px; text-align:center;">Weekly Report</div>
					<form class="filter-by-form" action="" method="POST">
						<div class="filter">
							<input style="font-size: 14px; color: #737373;padding-left: 10px; padding-right: 10px;" value="<?php echo $projected_date; ?>" type="week" name="projected_date" id="projected_date">
