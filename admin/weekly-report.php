		...
		<div class="main-content">
			...
			<div style="overflow-x:auto;" id="tblCustomers" cellspacing="0" cellpadding="0">
				...
				<table style="margin-top: 15px;">
					<?php
						$total_expenditure = 0;
						$query1 = "SELECT * FROM Expense WHERE YEARWEEK(created_at) = '$the_week' ORDER BY created_at DESC";
				...
				<?php 
					$remaining = 0;
					$income    = 0;
					$remaining_query  = "SELECT * FROM Income WHERE YEARWEEK(created_at) = '$the_week' ORDER BY created_at DESC";
