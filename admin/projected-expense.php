		...
		<div class="main-content">
			...
			<div style="overflow-x:auto;">
				...
				<table>
					<?php 
						$user_id = $_SESSION['user_id'];
						$query   = "SELECT * FROM ProjectedExpense WHERE YEAR(projected_date) = '$the_year' AND MONTH(projected_date) = '$the_month' ORDER BY created_at DESC";
						$results = mysqli_query($con, $query);
			...
			<div id="myModal" class="modal">
				<div class="modal-content">
					...
					<form class="add-projected-expense-validation" method="POST">
						...
						<div>
							<input class="button-primary" name="admin-add-projected-expense" type="submit" value="Add Projected Expense">
						</div>
					</form>  
