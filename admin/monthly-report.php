		...
		<div class="main-content">
			...
			<div style="overflow-x:auto;" id="tblCustomers" cellspacing="0" cellpadding="0">
				<div class="report-title">
					<div class="report-filter" style="font-size:18px; text-align:center;">Monthly Report</div>
				...
				<table style="margin-top: 15px;">
					<?php
						$total_expenditure = 0;
						$query1 = "SELECT * FROM Expense WHERE YEAR(created_at) = '$the_year' AND MONTH(created_at) = '$the_month' ORDER BY created_at DESC";
				...
				<?php 
					$remaining = 0;
					$income    = 0;
					$remaining_query  = "SELECT * FROM Income WHERE YEAR(created_at) = '$the_year' AND MONTH(created_at) = '$the_month' ORDER BY created_at DESC";
